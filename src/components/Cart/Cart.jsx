...
export default function Cart() {
  ...
  let  {getCartItem ,deleteCartItem,clearUserCart ,setCounter,updateQTY, setfooterFixed} = useContext(cartContext)
  ...
  if(data === null || data.numOfCartItems === 0){
  return <h2 className="text-center my-5 text-main mt-5 pt-5">No items in the cart</h2>
  }
  ...
  return (
    ...
    <div className='pt-5 '>
    <div className="container my-5 bg-main-light px-3 rounded-1 pt-5 ">
      <h2>Shop Cart:</h2>
      ...
      <button onClick={()=>clearCart()} className="btn btn-danger text-white ms-2" >clear the cart</button>
    </div>
    </div>
  )
}
