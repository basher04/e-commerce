...
export default function WishList() {
  ...
  let  {setCounter,addToCart,setfooterFixed} = useContext(cartContext)
  ...
  setisLoading(true)
  },[removeFromWish,addProductToCart])
...
if(data.length === 0 ){
return <h2 className="text-center my-5 text-main mt-5 pt-5">No items in the WishList</h2>
}

  
  return (
    <div className='pt-5'>
      <div className="container  bg-main-light px-3 rounded-1 my-5 pt-5">
